          ...
          <div className="flex justify-center mb-16">
            <div className="bg-card border border-border rounded-xl p-8 text-center shadow-sm max-w-sm">
              <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden">
                <img src={profileImage} alt="M. F. Davidson" className="w-full h-full object-cover" />
              </div>
              <h2 className="text-xl font-display font-semibold text-foreground mb-4">
                M. F. Davidson
              </h2>
              <div className="flex justify-center space-x-3">
                <a href="https://twitter.com/mfdavidson" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-muted hover:bg-muted/80 flex items-center justify-center transition-colors">
                  <svg className="w-4 h-4 text-foreground" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" />
                  </svg>
                </a>
                <a href="https://www.instagram.com/mfdavidson/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-muted hover:bg-muted/80 flex items-center justify-center transition-colors">
                  <svg className="w-4 h-4 text-foreground" viewBox="0 0 24 24" fill="currentColor">
